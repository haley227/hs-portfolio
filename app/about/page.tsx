...
const technologies = [
  ...
  {
    image: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/heroku/heroku-original.svg',
    serviceName: 'Heroku',
  },
  {
...
export default function About() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 flex" style={{gap: '100px'}}>
      <Nav />
        ...
        <div>
          ...
          <div className="flex flex-wrap mt-8 flex flex-wrap justify-between">
            {technologies.map((technology) => (
              <div key={technology.serviceName} className="hover:scale-125 dark:text-gray-800 py-2 px-4 bg-gray-50 md:m-4 mx-2 mt-6 rounded-lg flex items-center md:w-48 w-40">
                <Image alt="" width={100} height={100} src={technology.image} className="w-12" />
